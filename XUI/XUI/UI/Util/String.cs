...
public class StringUI
{
	...
	public unsafe void Add( int value, int minLength )
	{
		if ( Length == ( Size - 1 ) )
			return;
	...
	public void ConvertSecondsToTime( float time )
	{
		ConvertSecondsToTime( (double)time );
	}

	public void ConvertSecondsToTime( double time )
	{
