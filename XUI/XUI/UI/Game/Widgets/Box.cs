...
public class WidgetBox : WidgetBase
{
	...
	protected override void OnRender()
	{
		...
		// TL
		_UI.Sprite.AddSprite( RenderPass, Layer, x0, y0, pos.Z, sx1x0, sy1y0, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u0, v0, su1u0, sv1v0 );

		// TC
		_UI.Sprite.AddSprite( RenderPass, Layer, x1, y0, pos.Z, sx2x1, sy1y0, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u1, v0, su2u1, sv1v0 );

		// TR
		_UI.Sprite.AddSprite( RenderPass, Layer, x2, y0, pos.Z, sx3x2, sy1y0, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u2, v0, su3u2, sv1v0 );

		// ML
		_UI.Sprite.AddSprite( RenderPass, Layer, x0, y1, pos.Z, sx1x0, sy2y1, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u0, v1, su1u0, sv2v1 );

		// MC
		_UI.Sprite.AddSprite( RenderPass, Layer, x1, y1, pos.Z, sx2x1, sy2y1, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u1, v1, su2u1, sv2v1 );

		// MR
		_UI.Sprite.AddSprite( RenderPass, Layer, x2, y1, pos.Z, sx3x2, sy2y1, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u2, v1, su3u2, sv2v1 );

		// BL
		_UI.Sprite.AddSprite( RenderPass, Layer, x0, y2, pos.Z, sx1x0, sy3y2, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u0, v2, su1u0, sv3v2 );

		// BC
		_UI.Sprite.AddSprite( RenderPass, Layer, x1, y2, pos.Z, sx2x1, sy3y2, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
		_UI.Sprite.AddTexture( 0, tex.TextureIndex, u1, v2, su2u1, sv3v2 );

		// BR
		_UI.Sprite.AddSprite( RenderPass, Layer, x2, y2, pos.Z, sx3x2, sy3y2, 0.0f, E_Align.TopLeft, ref ColorFinal, ref RenderState );
